...
I had never heard of such a bug, so my first guess was that this was another high FPS bug. But the user said no, it happens at 60 FPS. Plus the claim that it only happened after progressing far enough into the game, and that it persisted after a reboot was strange...
